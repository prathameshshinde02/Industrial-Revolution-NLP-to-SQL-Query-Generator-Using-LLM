...
# CURRENT_TIME = "2025-02-08 05:01:17"
...
# # Streamlit app
# st.set_page_config(page_title="Gemini Text to SQL LLM App", layout="wide")
...
# is_modified = manual_query != st.session_state.last_executed_query

# col1, col2 = st.columns([1, 1])
# with col1:
#     # Only show execute button if query has been modified
#     if is_modified:
